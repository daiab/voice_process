...
def dirMp3toWavWrapper(directory, samplerate, channels):
    ...
    audio_basic_io.convertDirMP3ToWav(directory, samplerate, channels,
                                      useMp3TagsAsNames)
...
def dirWAVChangeFs(directory, samplerate, channels):
    ...
    audio_basic_io.convertFsDirWavToWav(directory, samplerate, channels)
...
def speakerDiarizationWrapper(inputFile, numSpeakers, useLDA):
    ...
    if useLDA:
        ...
        aS.speaker_diarization(inputFile, numSpeakers, lda_dim=0, plot=True)
